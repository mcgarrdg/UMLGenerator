...
public abstract class UMLGraphItem {
	...
	/**
	 * This should take the information in this class, and return a string in a
	 * format that describes the data in a way that GraphViz can recognize.
	 * 
	 ...
	 * 
	 * @param accessType
	 *            An integer representing the access type. See See
	 *            {@link Opcodes}.
